...
<div class="header_logo_wrap">
    			...
    			<?php 
    				...
    				echo $logo_before;
    					...
    					if( $textlogo ){
    						...
    						echo '<img class="logo-main   scale-with-grid" data-pin-no-hover="true" src="'. $logo_src .'" 	alt="'. get_bloginfo( 'name' ) .'" '. $width .'/>';
    						echo '<img class="logo-sticky scale-with-grid" data-pin-no-hover="true" src="'. $logo_sticky .'" alt="" '. $width .'/>';
    						echo '<img class="logo-mobile scale-with-grid" data-pin-no-hover="true" src="'. $logo_mobile .'" alt="" '. $width .'/>';
        ...
        <div id="pixelRight">
            <div class="romanov_contact_details">
                <div class="details_addr"><span>980 N. Michigan Ave, Chicago, IL, USA</span></div>
                ...
                <div class="details_email"><a href="mailto:info&#64;romanovrussia.com">info@romanovrussia.com</a></div>
            </div> 
        </div>
    </div>
	<div class="container">
