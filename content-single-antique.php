			...
			<div class="column two-third ">
				<div class="antique_masonry_wrap">
					...
					<div class="column antique_masonry one-second">
						<div class="image_frame image_item no_link scale-with-grid aligncenter has_border"><div class="image_wrapper"><a rel="prettyPhoto[myGallery]" href="<?php echo $image_url; ?>"><img class="scale-with-grid" src="<?php echo $image_url; ?>" alt="" width="479" height="447"></a></div></div>
					</div>
					<?php } ?>
				</div>				
			</div>
					...
					<div class="meta-value-parent">
						...
						<span class="meta-value reserved-status">
    						<?php if($status == "Sold") {
        						...
        						echo '<p data-toggle="tooltip" title="This item is reserved and waiting for the payment to be completed!">'. $status .'</p>';
    						}
    						else {
        						echo '<p>'. $status .'</p>';
    						} ?>
	...
	<div class="section section-post-footer">
		...
		<div class="section section-post-related">
			<div class="section_wrapper clearfix">
				...
				// var_dump( $post );
				// echo "</pre>";
				do_shortcode( '[ultimate_carousel title_text_typography="" slides_on_desk="4"][get_related_posts][/ultimate_carousel]' );
